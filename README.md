...
On-screen timer made to enhance your Mob Programming experience.
...
``` bash
git clone https://github.com/YoannBureau/mobshare.git
```
...
Kudos to https://github.com/maximegris/ for the angular-electron wrapper that saved me a lot of time.
